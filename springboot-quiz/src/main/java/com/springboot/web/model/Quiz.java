...
public class Quiz {
	...
	public Quiz(int id, String question, String answer, String option1, String option2, String option3,
			String option4) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Quiz [id=" + id + ", question=" + question + ", answer=" + answer + ", option1=" + option1
